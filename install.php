...
/*
$modules = scandir(rex_path::addon("link_checker")."module");

foreach ($modules as $module) {
    if ($module == "." || $module == "..") {
        continue;
    }
    $module_array = json_decode(rex_file::get(rex_path::addon("link_checker")."module/".$module), 1);
    ...
    ->setValue("createuser", "")
    ->setValue("updateuser", "link_checker")
